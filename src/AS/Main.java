...
public class Main {
    ...
    /**
     * sortedSetMenu The menu of choices for a Set implemented with a sorted array.
     */
    public static void sortedSetMenu() {
    ...
    /**
     * linkedSetMenu The menu of choices for a Set implemented with a sorted linked list.
     */
    public static void linkedSetMenu() {
    ...
    /**
     * unsortedSetMenu The menu of choices for a Set implemented with an unsorted array.
     */
    public static void unsortedSetMenu() {
