...
import sets.AdvancedSetLinkedList;

public class AdvancedSetLinkedListTests {
    private final AdvancedSetInterface<Integer> set = new AdvancedSetLinkedList<>();
    ...
    public void performUnionOfSetsWithDistinctElements() {
        set.add(1);
        AdvancedSetInterface<Integer> tempSet = new AdvancedSetLinkedList<>();
        tempSet.add(2);
