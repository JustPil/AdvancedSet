...
import sets.AdvancedSetSortedArray;

public class AdvancedSetSortedArrayTests {
    private final AdvancedSetInterface<Integer> set = new AdvancedSetSortedArray<>();
    ...
    public void performUnionOfSetsWithDistinctElements() {
        set.add(1);
        AdvancedSetInterface<Integer> tempSet = new AdvancedSetSortedArray<>();
        tempSet.add(2);
